...
const FALLBACK: PublicStoreSettings = {
  ...
  gpayUpiName: process.env.NEXT_PUBLIC_STORE_UPI_NAME ?? process.env.NEXT_PUBLIC_APP_NAME ?? '--',
  supportPhone: '--',
  supportEmail: '--',
  address: '--',
  whatsapp: '',
  ...
  storeUpiName: process.env.NEXT_PUBLIC_STORE_UPI_NAME ?? process.env.NEXT_PUBLIC_APP_NAME ?? '--',
  hours: { open: '--', close: '--' },
  tempReopensAt: '',
  orderByCutoffs: [],
  deliveryLocations: [],
  ...
  deliveryPersonName: process.env.NEXT_PUBLIC_APP_NAME ? `${process.env.NEXT_PUBLIC_APP_NAME} Delivery` : '--',
  deliveryPersonPhone: '--',
