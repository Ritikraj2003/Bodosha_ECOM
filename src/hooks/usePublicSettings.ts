...
const FALLBACK: PublicStoreSettings = {
  ...
  gpayUpiName: process.env.NEXT_PUBLIC_STORE_UPI_NAME ?? process.env.NEXT_PUBLIC_APP_NAME ?? 'Badmaas House Cafe',
  supportPhone: '',
  supportEmail: '',
  address: '',
  whatsapp: '',
  ...
  storeUpiName: process.env.NEXT_PUBLIC_STORE_UPI_NAME ?? process.env.NEXT_PUBLIC_APP_NAME ?? 'Badmaas House Cafe',
  ...
  deliveryPersonName: process.env.NEXT_PUBLIC_APP_NAME ? `${process.env.NEXT_PUBLIC_APP_NAME} Delivery` : 'Badmaas Delivery',
